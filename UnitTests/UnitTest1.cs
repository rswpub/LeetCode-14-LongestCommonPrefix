...
namespace UnitTests
{
    public class ProvideArrayOfStrings
    {
        ...
        [Theory]
        [InlineData(new string[] { "", "" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "" }, "***EXCEPTION***")]
        [InlineData(new string[] { "", "b" }, "***EXCEPTION***")]
        [InlineData(new string[] { "A" }, "***EXCEPTION***")]
        [InlineData(new string[] { "1" }, "***EXCEPTION***")]
        [InlineData(new string[] { "#" }, "***EXCEPTION***")]
        [InlineData(new string[] { " ", "" }, "***EXCEPTION***")]
        [InlineData(new string[] { "", " " }, "***EXCEPTION***")]
        [InlineData(new string[] { " ", " " }, "***EXCEPTION***")]
        [InlineData(new string[] { "  ", "  " }, "***EXCEPTION***")]
        [InlineData(new string[] { "   ", "  " }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "A" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "1" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "#" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "b", "A" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "a", "A" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "a", "aA" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "a", "abA" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a", "a1", "aA" }, "***EXCEPTION***")]
        [InlineData(new string[] { "a#", "a", "a" }, "***EXCEPTION***")]
        [InlineData(new string[] { "aaabcd", "aaabef", "" }, "***EXCEPTION***")]
